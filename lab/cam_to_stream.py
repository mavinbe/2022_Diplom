...
out = cv2.VideoWriter("appsrc ! videoconvert ! video/x-raw,format=I420 ! jpegenc ! rtpjpegpay ! rtpstreampay ! udpsink host=192.168.178.46 port=7001", cv2.CAP_GSTREAMER, 0, 24, (1280, 960), True)
...
while cap.isOpened():
    ...
    if ret:
        #frame = frame[478:, :]
        frame = cv2.resize(frame, (int(2560 / 2), int(1920 / 2)))
        #print(frame.shape)
